...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    repo: 'leirensheng/blog', // 导航栏右侧生成Github链接
    ...
    footer:{ // 页脚信息
      ...
      copyrightInfo: 'leirensheng | <a href="https://github.com/leirensheng/blog/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    }
  },
  plugins: [ // 插件
