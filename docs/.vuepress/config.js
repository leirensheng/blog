...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    repo: 'leirensheng/blob', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, link: String}
      name: 'leirensheng', // 必需
      link: 'https://github.com/leirensheng' // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:leirensheng@163.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/leirensheng'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer:{ // 页脚信息
      ...
      copyrightInfo: 'leirensheng | <a href="https://github.com/leirensheng/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    }
  },
  plugins: [ // 插件
